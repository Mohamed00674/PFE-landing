        ...
        <section class="section scroll-select" id="contact">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mt-4 pt-4">
                            <p class="mt-4"><span class="h5">Office Address :</span><br> <span class="text-muted d-block mt-2">Im n 9 rue Sidi Abdejalil,1008 Tunis</span></p>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="custom-form mt-4 pt-4">
                            <div id="message"></div>
                            <form  @submit.prevent="save" name="contact-form" id="contact-form">
                                <div class="row">
                                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-right">
                                        <input v-on:click="save" type="submit" id="submit" name="send" class="submitBnt btn btn-custom" value="Send Message">
